    ...
    return (
        ...
        <div
            ...
            <div
                ...
                <select
                    className={`${loading ? 'hidden' : '0'} bg-white text-gray-700 border border-gray-300 rounded-3xl h-10 m-5 w-40 self-center`}
                ...
                <button
                    ref={startButtonRef}
                    onClick={onStart}
                    className={`${loading ? 'hidden' : '0'}  bg-white hover:bg-blue-500 text-blue-700 font-semibold hover:text-white border border-blue-500 hover:border-transparent rounded-3xl h-10 m-5 min-w-32 w-44 self-center hover:scale-125 transition-all`} >
                    Start Camera
                </button>
